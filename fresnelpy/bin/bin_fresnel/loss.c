...
#define __PYX_HAVE__fresnelpy__bin__bin_fresnel__loss
#define __PYX_HAVE_API__fresnelpy__bin__bin_fresnel__loss
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "fresnelpy/bin/bin_fresnel/loss.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
#define __Pyx_MODULE_NAME "fresnelpy.bin.bin_fresnel.loss"
extern int __pyx_module_is_main_fresnelpy__bin__bin_fresnel__loss;
int __pyx_module_is_main_fresnelpy__bin__bin_fresnel__loss = 0;

/* Implementation of 'fresnelpy.bin.bin_fresnel.loss' */
...
/* "fresnelpy/bin/bin_fresnel/loss.pyx":11
 * 
 * 
...
static __Pyx_memviewslice __pyx_f_9fresnelpy_3bin_11bin_fresnel_4loss_bin_loss_matrix(__Pyx_memviewslice __pyx_v_reflection, __Pyx_memviewslice __pyx_v_loss) {
  Py_ssize_t __pyx_v_xmax;
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_j;
  Py_ssize_t __pyx_v_k;
  __Pyx_memviewslice __pyx_v_ref_loss = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("bin_loss_matrix", 0);

  /* "fresnelpy/bin/bin_fresnel/loss.pyx":13
 * cdef double[:, :, :] bin_loss_matrix(double[:, :, :] reflection, double[:] loss):
 *     cdef:
 *         Py_ssize_t xmax = loss.shape[0], i, j, k             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_xmax = (__pyx_v_loss.shape[0]);

  /* "fresnelpy/bin/bin_fresnel/loss.pyx":14
 *     cdef:
 *         Py_ssize_t xmax = loss.shape[0], i, j, k
 *         double[:, :, :] ref_loss = np.zeros_like(reflection)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_reflection, 3, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_ref_loss = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "fresnelpy/bin/bin_fresnel/loss.pyx":16
 *         double[:, :, :] ref_loss = np.zeros_like(reflection)
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "fresnelpy/bin/bin_fresnel/loss.pyx":17
 * 
 *     for i in range(xmax):
 *         for j in range(reflection.shape[1]):             # <<<<<<<<<<<<<<
 *             for k in range(reflection.shape[2]):
 ...
 */
    __pyx_t_9 = (__pyx_v_reflection.shape[1]);
    __pyx_t_10 = __pyx_t_9;
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      __pyx_v_j = __pyx_t_11;

      /* "fresnelpy/bin/bin_fresnel/loss.pyx":18
 *     for i in range(xmax):
 *         for j in range(reflection.shape[1]):
 *             for k in range(reflection.shape[2]):             # <<<<<<<<<<<<<<
 *                 ref_loss[i, j, k] = reflection[i, j, k] * loss[i]
 * 
 */
      __pyx_t_12 = (__pyx_v_reflection.shape[2]);
      __pyx_t_13 = __pyx_t_12;
      for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
        __pyx_v_k = __pyx_t_14;

        /* "fresnelpy/bin/bin_fresnel/loss.pyx":19
 *         for j in range(reflection.shape[1]):
 *             for k in range(reflection.shape[2]):
 *                 ref_loss[i, j, k] = reflection[i, j, k] * loss[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_18 = -1;
        if (__pyx_t_15 < 0) {
          __pyx_t_15 += __pyx_v_reflection.shape[0];
          if (unlikely(__pyx_t_15 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_15 >= __pyx_v_reflection.shape[0])) __pyx_t_18 = 0;
        if (__pyx_t_16 < 0) {
          __pyx_t_16 += __pyx_v_reflection.shape[1];
          if (unlikely(__pyx_t_16 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_16 >= __pyx_v_reflection.shape[1])) __pyx_t_18 = 1;
        if (__pyx_t_17 < 0) {
          __pyx_t_17 += __pyx_v_reflection.shape[2];
          if (unlikely(__pyx_t_17 < 0)) __pyx_t_18 = 2;
        } else if (unlikely(__pyx_t_17 >= __pyx_v_reflection.shape[2])) __pyx_t_18 = 2;
        ...
        __pyx_t_18 = -1;
        if (__pyx_t_19 < 0) {
          __pyx_t_19 += __pyx_v_loss.shape[0];
          if (unlikely(__pyx_t_19 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_19 >= __pyx_v_loss.shape[0])) __pyx_t_18 = 0;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 19, __pyx_L1_error)
        }
        ...
        __pyx_t_18 = -1;
        if (__pyx_t_20 < 0) {
          __pyx_t_20 += __pyx_v_ref_loss.shape[0];
          if (unlikely(__pyx_t_20 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_20 >= __pyx_v_ref_loss.shape[0])) __pyx_t_18 = 0;
        if (__pyx_t_21 < 0) {
          __pyx_t_21 += __pyx_v_ref_loss.shape[1];
          if (unlikely(__pyx_t_21 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_21 >= __pyx_v_ref_loss.shape[1])) __pyx_t_18 = 1;
        if (__pyx_t_22 < 0) {
          __pyx_t_22 += __pyx_v_ref_loss.shape[2];
          if (unlikely(__pyx_t_22 < 0)) __pyx_t_18 = 2;
        } else if (unlikely(__pyx_t_22 >= __pyx_v_ref_loss.shape[2])) __pyx_t_18 = 2;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 19, __pyx_L1_error)
        }
        *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ref_loss.data + __pyx_t_20 * __pyx_v_ref_loss.strides[0]) ) + __pyx_t_21 * __pyx_v_ref_loss.strides[1]) ) + __pyx_t_22 * __pyx_v_ref_loss.strides[2]) )) = ((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reflection.data + __pyx_t_15 * __pyx_v_reflection.strides[0]) ) + __pyx_t_16 * __pyx_v_reflection.strides[1]) ) + __pyx_t_17 * __pyx_v_reflection.strides[2]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_loss.data + __pyx_t_19 * __pyx_v_loss.strides[0]) ))));
      }
    }
  }

  /* "fresnelpy/bin/bin_fresnel/loss.pyx":21
 *                 ref_loss[i, j, k] = reflection[i, j, k] * loss[i]
 * 
 *     return ref_loss             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_ref_loss, 0);
  __pyx_r = __pyx_v_ref_loss;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("fresnelpy.bin.bin_fresnel.loss.bin_loss_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __pyx_L2:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_ref_loss, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fresnelpy.bin.bin_fresnel.loss.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fresnelpy.bin.bin_fresnel.loss.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fresnelpy.bin.bin_fresnel.loss.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fresnelpy.bin.bin_fresnel.loss._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("bin_loss_matrix", (void (*)(void))__pyx_f_9fresnelpy_3bin_11bin_fresnel_4loss_bin_loss_matrix, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("loss", __pyx_methods, __pyx_k_Created_on_18_04_19_by_ibaris, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fresnelpy__bin__bin_fresnel__loss) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fresnelpy.bin.bin_fresnel.loss")) {
      if (unlikely(PyDict_SetItemString(modules, "fresnelpy.bin.bin_fresnel.loss", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fresnelpy/bin/bin_fresnel/loss.pyx":7
 * """
 ...
 */
  ...
  /* "fresnelpy/bin/bin_fresnel/loss.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * # cython: cdivision=True
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fresnelpy.bin.bin_fresnel.loss", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fresnelpy.bin.bin_fresnel.loss");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
