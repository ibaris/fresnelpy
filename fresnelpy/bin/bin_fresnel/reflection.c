...
#define __PYX_HAVE__fresnelpy__bin__bin_fresnel__reflection
#define __PYX_HAVE_API__fresnelpy__bin__bin_fresnel__reflection
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "fresnelpy/bin/bin_fresnel/reflection.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
/* Module declarations from 'fresnelpy.bin.bin_fresnel.reflection' */
...
#define __Pyx_MODULE_NAME "fresnelpy.bin.bin_fresnel.reflection"
extern int __pyx_module_is_main_fresnelpy__bin__bin_fresnel__reflection;
int __pyx_module_is_main_fresnelpy__bin__bin_fresnel__reflection = 0;

/* Implementation of 'fresnelpy.bin.bin_fresnel.reflection' */
...
static const char __pyx_k_Created_on_18_04_19_by_ibaris[] = "\nCreated on 18.04.19 by ibaris\n";
...
/* "fresnelpy/bin/bin_fresnel/reflection.pyx":13
 * 
 * 
...
static PyObject *__pyx_f_9fresnelpy_3bin_11bin_fresnel_10reflection_bin_reflection(__Pyx_memviewslice __pyx_v_xza, __Pyx_memviewslice __pyx_v_eps) {
  ...
  __Pyx_RefNannySetupContext("bin_reflection", 0);

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":15
 * cdef tuple bin_reflection(double[:] xza, double complex[:] eps):
 *     cdef:
 *         Py_ssize_t xmax = xza.shape[0], i             # <<<<<<<<<<<<<<
 ...
 *         double complex rt
 */
  __pyx_v_xmax = (__pyx_v_xza.shape[0]);

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":16
 *     cdef:
 *         Py_ssize_t xmax = xza.shape[0], i
 *         double complex[:] Rvi = np.empty_like(eps), Rhi = np.empty_like(eps)             # <<<<<<<<<<<<<<
 *         double complex rt
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_empty_like); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_eps, 1, (PyObject *(*)(char *)) __pyx_memview_get___pyx_t_double_complex, (int (*)(char *, PyObject *)) __pyx_memview_set___pyx_t_double_complex, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 16, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_empty_like); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_eps, 1, (PyObject *(*)(char *)) __pyx_memview_get___pyx_t_double_complex, (int (*)(char *, PyObject *)) __pyx_memview_set___pyx_t_double_complex, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = NULL;
  ...
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_Rhi = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":19
 *         double complex rt
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":20
 * 
 *     for i in range(xmax):
 *         rt = cmath.sqrt(eps[i] - pow(sin(xza[i]), 2))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_cmath); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_v_eps.shape[0];
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_9 >= __pyx_v_eps.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 20, __pyx_L1_error)
    }
    __pyx_t_11 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_eps.data + __pyx_t_9 * __pyx_v_eps.strides[0]) )));
    __pyx_t_2 = __pyx_PyComplex_FromComplex(__pyx_t_11); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_12 = __pyx_v_i;
    __pyx_t_10 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_xza.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_xza.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 20, __pyx_L1_error)
    }
    __pyx_t_4 = PyFloat_FromDouble(sin((*((double *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_12 * __pyx_v_xza.strides[0]) ))))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_13 = __Pyx_PyNumber_Power2(__pyx_t_4, __pyx_int_2); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyNumber_Subtract(__pyx_t_2, __pyx_t_13); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    __pyx_t_1 = (__pyx_t_13) ? __Pyx_PyObject_Call2Args(__pyx_t_3, __pyx_t_13, __pyx_t_4) : __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_4);
    __Pyx_XDECREF(__pyx_t_13); __pyx_t_13 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_11 = __Pyx_PyComplex_As___pyx_t_double_complex(__pyx_t_1); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_v_rt = __pyx_t_11;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":22
 *         rt = cmath.sqrt(eps[i] - pow(sin(xza[i]), 2))
 * 
 *         Rvi[i] = (eps[i] * cos(xza[i]) - rt) / (eps[i] * cos(xza[i]) + rt)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    } else if (unlikely(__pyx_t_14 >= __pyx_v_eps.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_v_xza.shape[0];
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_xza.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 22, __pyx_L1_error)
    }
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_v_eps.shape[0];
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_16 >= __pyx_v_eps.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 22, __pyx_L1_error)
    }
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_17 < 0) {
      __pyx_t_17 += __pyx_v_xza.shape[0];
      if (unlikely(__pyx_t_17 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_17 >= __pyx_v_xza.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 22, __pyx_L1_error)
    }
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_18 < 0) {
      __pyx_t_18 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_18 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_18 >= __pyx_v_Rvi.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 22, __pyx_L1_error)
    }
    *((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_18 * __pyx_v_Rvi.strides[0]) )) = __Pyx_c_quot_double(__Pyx_c_diff_double(__Pyx_c_prod_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_eps.data + __pyx_t_14 * __pyx_v_eps.strides[0]) ))), __pyx_t_double_complex_from_parts(cos((*((double *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_15 * __pyx_v_xza.strides[0]) )))), 0)), __pyx_v_rt), __Pyx_c_sum_double(__Pyx_c_prod_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_eps.data + __pyx_t_16 * __pyx_v_eps.strides[0]) ))), __pyx_t_double_complex_from_parts(cos((*((double *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_17 * __pyx_v_xza.strides[0]) )))), 0)), __pyx_v_rt));

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":23
 * 
 *         Rvi[i] = (eps[i] * cos(xza[i]) - rt) / (eps[i] * cos(xza[i]) + rt)
 *         Rhi[i] = (np.cos(xza[i]) - rt) / (cos(xza[i]) + rt)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_19 < 0) {
      __pyx_t_19 += __pyx_v_xza.shape[0];
      if (unlikely(__pyx_t_19 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_19 >= __pyx_v_xza.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 23, __pyx_L1_error)
    }
    __pyx_t_3 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_19 * __pyx_v_xza.strides[0]) )))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_13 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __pyx_PyComplex_FromComplex(__pyx_v_rt); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_20 < 0) {
      __pyx_t_20 += __pyx_v_xza.shape[0];
      if (unlikely(__pyx_t_20 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_20 >= __pyx_v_xza.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 23, __pyx_L1_error)
    }
    __pyx_t_11 = __Pyx_c_sum_double(__pyx_t_double_complex_from_parts(cos((*((double *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_20 * __pyx_v_xza.strides[0]) )))), 0), __pyx_v_rt);
    __pyx_t_4 = __pyx_PyComplex_FromComplex(__pyx_t_11); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_1 = __Pyx_PyNumber_Divide(__pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_11 = __Pyx_PyComplex_As___pyx_t_double_complex(__pyx_t_1); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_21 = __pyx_v_i;
    __pyx_t_10 = -1;
    if (__pyx_t_21 < 0) {
      __pyx_t_21 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_21 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_21 >= __pyx_v_Rhi.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 23, __pyx_L1_error)
    }
    *((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_21 * __pyx_v_Rhi.strides[0]) )) = __pyx_t_11;
  }

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":25
 *         Rhi[i] = (np.cos(xza[i]) - rt) / (cos(xza[i]) + rt)
 * 
 *     return Rvi, Rhi             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_Rvi, 1, (PyObject *(*)(char *)) __pyx_memview_get___pyx_t_double_complex, (int (*)(char *, PyObject *)) __pyx_memview_set___pyx_t_double_complex, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_Rhi, 1, (PyObject *(*)(char *)) __pyx_memview_get___pyx_t_double_complex, (int (*)(char *, PyObject *)) __pyx_memview_set___pyx_t_double_complex, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  ...
  __Pyx_AddTraceback("fresnelpy.bin.bin_fresnel.reflection.bin_reflection", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "fresnelpy/bin/bin_fresnel/reflection.pyx":28
 * 
 * 
...
static __Pyx_memviewslice __pyx_f_9fresnelpy_3bin_11bin_fresnel_10reflection_bin_reflection_matrix(__Pyx_memviewslice __pyx_v_xza, __Pyx_memviewslice __pyx_v_eps) {
  Py_ssize_t __pyx_v_xmax;
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_Rvi = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_Rhi = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("bin_reflection_matrix", 0);

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":30
 * cdef double[:, :, :] bin_reflection_matrix(double[:] xza, double complex[:] eps):
 *     cdef:
 *         Py_ssize_t xmax = xza.shape[0], i             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":32
 *         Py_ssize_t xmax = xza.shape[0], i
 *         double complex[:] Rvi, Rhi
 *         double[:, :, :] matrix = np.zeros((xmax, 4, 4))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_xmax); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_matrix = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":34
 *         double[:, :, :] matrix = np.zeros((xmax, 4, 4))
 * 
 *     Rvi, Rhi = bin_reflection(xza, eps)             # <<<<<<<<<<<<<<
 * 
 *     for i in range(xmax):
 */
  __pyx_t_1 = __pyx_f_9fresnelpy_3bin_11bin_fresnel_10reflection_bin_reflection(__pyx_v_xza, __pyx_v_eps); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_Rvi = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;
  __pyx_v_Rhi = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":36
 *     Rvi, Rhi = bin_reflection(xza, eps)
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":37
 * 
 *     for i in range(xmax):
 *         matrix[i, 0, 0] = pow(abs(Rvi[i]), 2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 37, __pyx_L1_error)
    }
    __pyx_t_1 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_11 * __pyx_v_Rvi.strides[0]) ))))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_4 = __Pyx_PyNumber_Power2(__pyx_t_1, __pyx_int_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    } else if (unlikely(__pyx_t_14 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_16 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 37, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_14 * __pyx_v_matrix.strides[0]) ) + __pyx_t_15 * __pyx_v_matrix.strides[1]) ) + __pyx_t_16 * __pyx_v_matrix.strides[2]) )) = __pyx_t_13;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":39
 *         matrix[i, 0, 0] = pow(abs(Rvi[i]), 2)
 * 
 *         matrix[i, 1, 1] = pow(abs(Rhi[i]), 2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_17 < 0) {
      __pyx_t_17 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_17 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_17 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 39, __pyx_L1_error)
    }
    __pyx_t_4 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_17 * __pyx_v_Rhi.strides[0]) ))))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 39, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_1 = __Pyx_PyNumber_Power2(__pyx_t_4, __pyx_int_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 39, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_13 = __pyx_PyFloat_AsDouble(__pyx_t_1); if (unlikely((__pyx_t_13 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_18 = __pyx_v_i;
    __pyx_t_19 = 1;
    __pyx_t_20 = 1;
    __pyx_t_12 = -1;
    if (__pyx_t_18 < 0) {
      __pyx_t_18 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_18 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_18 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_19 < 0) {
      __pyx_t_19 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_19 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_19 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_20 < 0) {
      __pyx_t_20 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_20 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_20 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 39, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_18 * __pyx_v_matrix.strides[0]) ) + __pyx_t_19 * __pyx_v_matrix.strides[1]) ) + __pyx_t_20 * __pyx_v_matrix.strides[2]) )) = __pyx_t_13;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":41
 *         matrix[i, 1, 1] = pow(abs(Rhi[i]), 2)
 * 
 *         matrix[i, 2, 2] = np.real(Rvi[i] * np.conjugate(Rhi[i]))             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_21 < 0) {
      __pyx_t_21 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_21 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_21 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    __pyx_t_22 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_21 * __pyx_v_Rvi.strides[0]) )));
    __pyx_t_4 = __pyx_PyComplex_FromComplex(__pyx_t_22); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_GetModuleGlobalName(__pyx_t_23, __pyx_n_s_np); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_23);
    __pyx_t_24 = __Pyx_PyObject_GetAttrStr(__pyx_t_23, __pyx_n_s_conjugate); if (unlikely(!__pyx_t_24)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_24);
    __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    __pyx_t_25 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_25 < 0) {
      __pyx_t_25 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_25 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_25 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    __pyx_t_22 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_25 * __pyx_v_Rhi.strides[0]) )));
    __pyx_t_23 = __pyx_PyComplex_FromComplex(__pyx_t_22); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_23);
    __pyx_t_26 = NULL;
    ...
    __pyx_t_2 = (__pyx_t_26) ? __Pyx_PyObject_Call2Args(__pyx_t_24, __pyx_t_26, __pyx_t_23) : __Pyx_PyObject_CallOneArg(__pyx_t_24, __pyx_t_23);
    __Pyx_XDECREF(__pyx_t_26); __pyx_t_26 = 0;
    __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_24); __pyx_t_24 = 0;
    __pyx_t_24 = PyNumber_Multiply(__pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_24)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_24);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = NULL;
    ...
    __pyx_t_1 = (__pyx_t_2) ? __Pyx_PyObject_Call2Args(__pyx_t_3, __pyx_t_2, __pyx_t_24) : __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_24);
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_24); __pyx_t_24 = 0;
    if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_13 = __pyx_PyFloat_AsDouble(__pyx_t_1); if (unlikely((__pyx_t_13 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_27 < 0) {
      __pyx_t_27 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_27 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_27 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_28 < 0) {
      __pyx_t_28 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_28 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_28 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_29 < 0) {
      __pyx_t_29 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_29 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_29 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_27 * __pyx_v_matrix.strides[0]) ) + __pyx_t_28 * __pyx_v_matrix.strides[1]) ) + __pyx_t_29 * __pyx_v_matrix.strides[2]) )) = __pyx_t_13;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":42
 * 
 *         matrix[i, 2, 2] = np.real(Rvi[i] * np.conjugate(Rhi[i]))
 *         matrix[i, 2, 3] = -np.imag(Rvi[i] * np.conjugate(Rhi[i]))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_24 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_imag); if (unlikely(!__pyx_t_24)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_24);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_30 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_30 < 0) {
      __pyx_t_30 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_30 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_30 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 42, __pyx_L1_error)
    }
    __pyx_t_22 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_30 * __pyx_v_Rvi.strides[0]) )));
    __pyx_t_3 = __pyx_PyComplex_FromComplex(__pyx_t_22); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_23 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_conjugate); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_23);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_31 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_31 < 0) {
      __pyx_t_31 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_31 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_31 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 42, __pyx_L1_error)
    }
    __pyx_t_22 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_31 * __pyx_v_Rhi.strides[0]) )));
    __pyx_t_4 = __pyx_PyComplex_FromComplex(__pyx_t_22); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_26 = NULL;
    ...
    __pyx_t_2 = (__pyx_t_26) ? __Pyx_PyObject_Call2Args(__pyx_t_23, __pyx_t_26, __pyx_t_4) : __Pyx_PyObject_CallOneArg(__pyx_t_23, __pyx_t_4);
    __Pyx_XDECREF(__pyx_t_26); __pyx_t_26 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    __pyx_t_23 = PyNumber_Multiply(__pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_23);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = NULL;
    ...
    __pyx_t_1 = (__pyx_t_2) ? __Pyx_PyObject_Call2Args(__pyx_t_24, __pyx_t_2, __pyx_t_23) : __Pyx_PyObject_CallOneArg(__pyx_t_24, __pyx_t_23);
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_24); __pyx_t_24 = 0;
    __pyx_t_24 = PyNumber_Negative(__pyx_t_1); if (unlikely(!__pyx_t_24)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_24);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_13 = __pyx_PyFloat_AsDouble(__pyx_t_24); if (unlikely((__pyx_t_13 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_24); __pyx_t_24 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_32 < 0) {
      __pyx_t_32 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_32 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_32 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_33 < 0) {
      __pyx_t_33 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_33 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_33 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_34 < 0) {
      __pyx_t_34 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_34 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_34 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 42, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_32 * __pyx_v_matrix.strides[0]) ) + __pyx_t_33 * __pyx_v_matrix.strides[1]) ) + __pyx_t_34 * __pyx_v_matrix.strides[2]) )) = __pyx_t_13;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":44
 *         matrix[i, 2, 3] = -np.imag(Rvi[i] * np.conjugate(Rhi[i]))
 * 
 *         matrix[i, 3, 2] = np.imag(Rvi[i] * np.conjugate(Rhi[i]))             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_23 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_imag); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_23);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_35 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_35 < 0) {
      __pyx_t_35 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_35 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_35 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 44, __pyx_L1_error)
    }
    __pyx_t_22 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_35 * __pyx_v_Rvi.strides[0]) )));
    __pyx_t_1 = __pyx_PyComplex_FromComplex(__pyx_t_22); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_conjugate); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_36 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_36 < 0) {
      __pyx_t_36 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_36 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_36 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 44, __pyx_L1_error)
    }
    __pyx_t_22 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_36 * __pyx_v_Rhi.strides[0]) )));
    __pyx_t_3 = __pyx_PyComplex_FromComplex(__pyx_t_22); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_26 = NULL;
    if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_4))) {
    ...
    __pyx_t_2 = (__pyx_t_26) ? __Pyx_PyObject_Call2Args(__pyx_t_4, __pyx_t_26, __pyx_t_3) : __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_3);
    __Pyx_XDECREF(__pyx_t_26); __pyx_t_26 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    __pyx_t_24 = (__pyx_t_2) ? __Pyx_PyObject_Call2Args(__pyx_t_23, __pyx_t_2, __pyx_t_4) : __Pyx_PyObject_CallOneArg(__pyx_t_23, __pyx_t_4);
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    if (unlikely(!__pyx_t_24)) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_24);
    __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    __pyx_t_13 = __pyx_PyFloat_AsDouble(__pyx_t_24); if (unlikely((__pyx_t_13 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_24); __pyx_t_24 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_37 < 0) {
      __pyx_t_37 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_37 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_37 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_38 < 0) {
      __pyx_t_38 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_38 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_38 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_39 < 0) {
      __pyx_t_39 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_39 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_39 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 44, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_37 * __pyx_v_matrix.strides[0]) ) + __pyx_t_38 * __pyx_v_matrix.strides[1]) ) + __pyx_t_39 * __pyx_v_matrix.strides[2]) )) = __pyx_t_13;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":45
 * 
 *         matrix[i, 3, 2] = np.imag(Rvi[i] * np.conjugate(Rhi[i]))
 *         matrix[i, 3, 3] = np.real(Rvi[i] * np.conjugate(Rhi[i]))             # <<<<<<<<<<<<<<
 * 
 *     return matrix
 */
    __Pyx_GetModuleGlobalName(__pyx_t_23, __pyx_n_s_np); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_23);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_23, __pyx_n_s_real); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    __pyx_t_40 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_40 < 0) {
      __pyx_t_40 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_40 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_40 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 45, __pyx_L1_error)
    }
    __pyx_t_22 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_40 * __pyx_v_Rvi.strides[0]) )));
    __pyx_t_23 = __pyx_PyComplex_FromComplex(__pyx_t_22); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_23);
    __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_conjugate); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_41 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_41 < 0) {
      __pyx_t_41 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_41 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_41 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 45, __pyx_L1_error)
    }
    __pyx_t_22 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_41 * __pyx_v_Rhi.strides[0]) )));
    __pyx_t_1 = __pyx_PyComplex_FromComplex(__pyx_t_22); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_26 = NULL;
    if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
    ...
    __pyx_t_2 = (__pyx_t_26) ? __Pyx_PyObject_Call2Args(__pyx_t_3, __pyx_t_26, __pyx_t_1) : __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_1);
    __Pyx_XDECREF(__pyx_t_26); __pyx_t_26 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Multiply(__pyx_t_23, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_23); __pyx_t_23 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_24);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_13 = __pyx_PyFloat_AsDouble(__pyx_t_24); if (unlikely((__pyx_t_13 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_24); __pyx_t_24 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_42 < 0) {
      __pyx_t_42 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_42 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_42 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_43 < 0) {
      __pyx_t_43 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_43 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_43 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_44 < 0) {
      __pyx_t_44 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_44 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_44 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 45, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_42 * __pyx_v_matrix.strides[0]) ) + __pyx_t_43 * __pyx_v_matrix.strides[1]) ) + __pyx_t_44 * __pyx_v_matrix.strides[2]) )) = __pyx_t_13;
  }

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":47
 *         matrix[i, 3, 3] = np.real(Rvi[i] * np.conjugate(Rhi[i]))
 * 
 *     return matrix             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("fresnelpy.bin.bin_fresnel.reflection.bin_reflection_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* "fresnelpy/bin/bin_fresnel/reflection.pyx":50
 * 
 * 
...
static __Pyx_memviewslice __pyx_f_9fresnelpy_3bin_11bin_fresnel_10reflection_bin_reflection_matrix_extended(__Pyx_memviewslice __pyx_v_xza, __Pyx_memviewslice __pyx_v_eps) {
  Py_ssize_t __pyx_v_xmax;
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_Rvi = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_Rhi = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("bin_reflection_matrix_extended", 0);

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":52
 * cdef double[:, :, :] bin_reflection_matrix_extended(double[:] xza, double complex[:] eps):
 *     cdef:
 *         Py_ssize_t xmax = xza.shape[0], i             # <<<<<<<<<<<<<<
 *         double complex[:] Rvi, Rhi
 ...
 */
  ...
  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":54
 *         Py_ssize_t xmax = xza.shape[0], i
 *         double complex[:] Rvi, Rhi
 *         double[:, :, :] matrix = np.zeros((xmax, 5, 5))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_xmax); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_matrix = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":56
 *         double[:, :, :] matrix = np.zeros((xmax, 5, 5))
 * 
 *     Rvi, Rhi = bin_reflection(xza, eps)             # <<<<<<<<<<<<<<
 * 
 *     for i in range(xmax):
 */
  __pyx_t_1 = __pyx_f_9fresnelpy_3bin_11bin_fresnel_10reflection_bin_reflection(__pyx_v_xza, __pyx_v_eps); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (likely(__pyx_t_1 != Py_None)) {
    PyObject* sequence = __pyx_t_1;
    Py_ssize_t size = __Pyx_PySequence_SIZE(sequence);
  ...
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_Rvi = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;
  ...
  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":58
 *     Rvi, Rhi = bin_reflection(xza, eps)
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":59
 * 
 *     for i in range(xmax):
 *         matrix[i, 0, 0] = 0.5 * (pow(abs(Rvi[i]), 2) + pow(abs(Rhi[i]), 2))             # <<<<<<<<<<<<<<
 *         matrix[i, 0, 1] = 0.5 * pow(abs(Rvi[i]), 2)
 ...
 */
    ...
    __pyx_t_1 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_11 * __pyx_v_Rvi.strides[0]) ))))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 59, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_4 = __Pyx_PyNumber_Power2(__pyx_t_1, __pyx_int_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 59, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_13 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 59, __pyx_L1_error)
    }
    __pyx_t_1 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_13 * __pyx_v_Rhi.strides[0]) ))))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 59, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyNumber_Power2(__pyx_t_1, __pyx_int_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 59, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Multiply(__pyx_float_0_5, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 59, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_14 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_14 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 59, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_15 = __pyx_v_i;
    __pyx_t_16 = 0;
    __pyx_t_17 = 0;
    ...
    } else if (unlikely(__pyx_t_15 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_16 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_17 < 0) {
      __pyx_t_17 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_17 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_17 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 59, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_15 * __pyx_v_matrix.strides[0]) ) + __pyx_t_16 * __pyx_v_matrix.strides[1]) ) + __pyx_t_17 * __pyx_v_matrix.strides[2]) )) = __pyx_t_14;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":60
 *     for i in range(xmax):
 *         matrix[i, 0, 0] = 0.5 * (pow(abs(Rvi[i]), 2) + pow(abs(Rhi[i]), 2))
 *         matrix[i, 0, 1] = 0.5 * pow(abs(Rvi[i]), 2)             # <<<<<<<<<<<<<<
 *         matrix[i, 0, 2] = -0.5 * pow(abs(Rhi[i]), 2)
 ...
 */
    ...
    if (__pyx_t_18 < 0) {
      __pyx_t_18 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_18 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_18 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 60, __pyx_L1_error)
    }
    __pyx_t_3 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_18 * __pyx_v_Rvi.strides[0]) ))))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_1 = __Pyx_PyNumber_Power2(__pyx_t_3, __pyx_int_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_19 < 0) {
      __pyx_t_19 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_19 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_19 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_20 < 0) {
      __pyx_t_20 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_20 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_20 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_21 < 0) {
      __pyx_t_21 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_21 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_21 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 60, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_19 * __pyx_v_matrix.strides[0]) ) + __pyx_t_20 * __pyx_v_matrix.strides[1]) ) + __pyx_t_21 * __pyx_v_matrix.strides[2]) )) = __pyx_t_14;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":61
 *         matrix[i, 0, 0] = 0.5 * (pow(abs(Rvi[i]), 2) + pow(abs(Rhi[i]), 2))
 *         matrix[i, 0, 1] = 0.5 * pow(abs(Rvi[i]), 2)
 *         matrix[i, 0, 2] = -0.5 * pow(abs(Rhi[i]), 2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_22 < 0) {
      __pyx_t_22 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_22 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_22 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 61, __pyx_L1_error)
    }
    __pyx_t_3 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_22 * __pyx_v_Rhi.strides[0]) ))))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_1 = __Pyx_PyNumber_Power2(__pyx_t_3, __pyx_int_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Multiply(__pyx_float_neg_0_5, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_14 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_14 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 61, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_23 < 0) {
      __pyx_t_23 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_23 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_23 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_24 < 0) {
      __pyx_t_24 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_24 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_24 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_25 < 0) {
      __pyx_t_25 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_25 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_25 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 61, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_23 * __pyx_v_matrix.strides[0]) ) + __pyx_t_24 * __pyx_v_matrix.strides[1]) ) + __pyx_t_25 * __pyx_v_matrix.strides[2]) )) = __pyx_t_14;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":63
 *         matrix[i, 0, 2] = -0.5 * pow(abs(Rhi[i]), 2)
 * 
 *         matrix[i, 1, 1] = pow(abs(Rvi[i]), 2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_26 < 0) {
      __pyx_t_26 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_26 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_26 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 63, __pyx_L1_error)
    }
    __pyx_t_3 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_26 * __pyx_v_Rvi.strides[0]) ))))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_1 = __Pyx_PyNumber_Power2(__pyx_t_3, __pyx_int_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_27 * __pyx_v_matrix.strides[0]) ) + __pyx_t_28 * __pyx_v_matrix.strides[1]) ) + __pyx_t_29 * __pyx_v_matrix.strides[2]) )) = __pyx_t_14;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":65
 *         matrix[i, 1, 1] = pow(abs(Rvi[i]), 2)
 * 
 *         matrix[i, 2, 2] = pow(abs(Rhi[i]), 2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_30 < 0) {
      __pyx_t_30 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_30 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_30 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 65, __pyx_L1_error)
    }
    __pyx_t_1 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_30 * __pyx_v_Rhi.strides[0]) ))))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyNumber_Power2(__pyx_t_1, __pyx_int_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 65, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    if (__pyx_t_31 < 0) {
      ...
      if (unlikely(__pyx_t_31 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_31 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_32 < 0) {
      __pyx_t_32 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_32 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_32 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_33 < 0) {
      __pyx_t_33 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_33 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_33 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 65, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_31 * __pyx_v_matrix.strides[0]) ) + __pyx_t_32 * __pyx_v_matrix.strides[1]) ) + __pyx_t_33 * __pyx_v_matrix.strides[2]) )) = __pyx_t_14;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":67
 *         matrix[i, 2, 2] = pow(abs(Rhi[i]), 2)
 * 
 *         matrix[i, 3, 3] = np.real(Rvi[i] * np.conjugate(Rhi[i]))             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_real); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_34 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_34 < 0) {
      __pyx_t_34 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_34 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_34 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 67, __pyx_L1_error)
    }
    __pyx_t_35 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_34 * __pyx_v_Rvi.strides[0]) )));
    __pyx_t_1 = __pyx_PyComplex_FromComplex(__pyx_t_35); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_GetModuleGlobalName(__pyx_t_36, __pyx_n_s_np); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __pyx_t_37 = __Pyx_PyObject_GetAttrStr(__pyx_t_36, __pyx_n_s_conjugate); if (unlikely(!__pyx_t_37)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_37);
    __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
    __pyx_t_38 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_38 < 0) {
      __pyx_t_38 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_38 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_38 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 67, __pyx_L1_error)
    }
    __pyx_t_35 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_38 * __pyx_v_Rhi.strides[0]) )));
    __pyx_t_36 = __pyx_PyComplex_FromComplex(__pyx_t_35); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __pyx_t_39 = NULL;
    ...
    __pyx_t_2 = (__pyx_t_39) ? __Pyx_PyObject_Call2Args(__pyx_t_37, __pyx_t_39, __pyx_t_36) : __Pyx_PyObject_CallOneArg(__pyx_t_37, __pyx_t_36);
    ...
    __pyx_t_37 = PyNumber_Multiply(__pyx_t_1, __pyx_t_2); if (unlikely(!__pyx_t_37)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_37);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = NULL;
    ...
    __pyx_t_3 = (__pyx_t_2) ? __Pyx_PyObject_Call2Args(__pyx_t_4, __pyx_t_2, __pyx_t_37) : __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_37);
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_37); __pyx_t_37 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_40 < 0) {
      __pyx_t_40 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_40 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_40 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_41 < 0) {
      __pyx_t_41 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_41 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_41 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_42 < 0) {
      __pyx_t_42 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_42 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_42 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 67, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_40 * __pyx_v_matrix.strides[0]) ) + __pyx_t_41 * __pyx_v_matrix.strides[1]) ) + __pyx_t_42 * __pyx_v_matrix.strides[2]) )) = __pyx_t_14;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":68
 * 
 *         matrix[i, 3, 3] = np.real(Rvi[i] * np.conjugate(Rhi[i]))
 *         matrix[i, 3, 4] = -np.imag(Rvi[i] * np.conjugate(Rhi[i]))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_37 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_imag); if (unlikely(!__pyx_t_37)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_37);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_43 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_43 < 0) {
      __pyx_t_43 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_43 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_43 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 68, __pyx_L1_error)
    }
    __pyx_t_35 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_43 * __pyx_v_Rvi.strides[0]) )));
    __pyx_t_4 = __pyx_PyComplex_FromComplex(__pyx_t_35); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_36 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_conjugate); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_44 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_44 < 0) {
      __pyx_t_44 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_44 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_44 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 68, __pyx_L1_error)
    }
    __pyx_t_35 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_44 * __pyx_v_Rhi.strides[0]) )));
    __pyx_t_1 = __pyx_PyComplex_FromComplex(__pyx_t_35); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_39 = NULL;
    ...
    __pyx_t_2 = (__pyx_t_39) ? __Pyx_PyObject_Call2Args(__pyx_t_36, __pyx_t_39, __pyx_t_1) : __Pyx_PyObject_CallOneArg(__pyx_t_36, __pyx_t_1);
    __Pyx_XDECREF(__pyx_t_39); __pyx_t_39 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
    __pyx_t_36 = PyNumber_Multiply(__pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = NULL;
    ...
    __pyx_t_3 = (__pyx_t_2) ? __Pyx_PyObject_Call2Args(__pyx_t_37, __pyx_t_2, __pyx_t_36) : __Pyx_PyObject_CallOneArg(__pyx_t_37, __pyx_t_36);
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
    if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_37); __pyx_t_37 = 0;
    __pyx_t_37 = PyNumber_Negative(__pyx_t_3); if (unlikely(!__pyx_t_37)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_37);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_14 = __pyx_PyFloat_AsDouble(__pyx_t_37); if (unlikely((__pyx_t_14 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_37); __pyx_t_37 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_45 < 0) {
      __pyx_t_45 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_45 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_45 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_46 < 0) {
      __pyx_t_46 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_46 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_46 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_47 < 0) {
      __pyx_t_47 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_47 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_47 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 68, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_45 * __pyx_v_matrix.strides[0]) ) + __pyx_t_46 * __pyx_v_matrix.strides[1]) ) + __pyx_t_47 * __pyx_v_matrix.strides[2]) )) = __pyx_t_14;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":70
 *         matrix[i, 3, 4] = -np.imag(Rvi[i] * np.conjugate(Rhi[i]))
 * 
 *         matrix[i, 4, 3] = np.imag(Rvi[i] * np.conjugate(Rhi[i]))             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_36 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_imag); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_48 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_48 < 0) {
      __pyx_t_48 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_48 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_48 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 70, __pyx_L1_error)
    }
    __pyx_t_35 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_48 * __pyx_v_Rvi.strides[0]) )));
    __pyx_t_3 = __pyx_PyComplex_FromComplex(__pyx_t_35); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_conjugate); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_49 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_49 < 0) {
      __pyx_t_49 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_49 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_49 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 70, __pyx_L1_error)
    }
    __pyx_t_35 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_49 * __pyx_v_Rhi.strides[0]) )));
    __pyx_t_4 = __pyx_PyComplex_FromComplex(__pyx_t_35); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_39 = NULL;
    ...
    __pyx_t_2 = (__pyx_t_39) ? __Pyx_PyObject_Call2Args(__pyx_t_1, __pyx_t_39, __pyx_t_4) : __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_4);
    __Pyx_XDECREF(__pyx_t_39); __pyx_t_39 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __pyx_t_37 = (__pyx_t_2) ? __Pyx_PyObject_Call2Args(__pyx_t_36, __pyx_t_2, __pyx_t_1) : __Pyx_PyObject_CallOneArg(__pyx_t_36, __pyx_t_1);
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (unlikely(!__pyx_t_37)) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_37);
    __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
    __pyx_t_14 = __pyx_PyFloat_AsDouble(__pyx_t_37); if (unlikely((__pyx_t_14 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 70, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_37); __pyx_t_37 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_50 < 0) {
      __pyx_t_50 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_50 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_50 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_51 < 0) {
      __pyx_t_51 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_51 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_51 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_52 < 0) {
      __pyx_t_52 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_52 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_52 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 70, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_50 * __pyx_v_matrix.strides[0]) ) + __pyx_t_51 * __pyx_v_matrix.strides[1]) ) + __pyx_t_52 * __pyx_v_matrix.strides[2]) )) = __pyx_t_14;

    /* "fresnelpy/bin/bin_fresnel/reflection.pyx":71
 * 
 *         matrix[i, 4, 3] = np.imag(Rvi[i] * np.conjugate(Rhi[i]))
 *         matrix[i, 4, 4] = np.real(Rvi[i] * np.conjugate(Rhi[i]))             # <<<<<<<<<<<<<<
 * 
 *     return matrix
 */
    __Pyx_GetModuleGlobalName(__pyx_t_36, __pyx_n_s_np); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_36, __pyx_n_s_real); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
    __pyx_t_53 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_53 < 0) {
      __pyx_t_53 += __pyx_v_Rvi.shape[0];
      if (unlikely(__pyx_t_53 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_53 >= __pyx_v_Rvi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 71, __pyx_L1_error)
    }
    __pyx_t_35 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rvi.data + __pyx_t_53 * __pyx_v_Rvi.strides[0]) )));
    __pyx_t_36 = __pyx_PyComplex_FromComplex(__pyx_t_35); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_36);
    __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_conjugate); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_54 = __pyx_v_i;
    __pyx_t_12 = -1;
    if (__pyx_t_54 < 0) {
      __pyx_t_54 += __pyx_v_Rhi.shape[0];
      if (unlikely(__pyx_t_54 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_54 >= __pyx_v_Rhi.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 71, __pyx_L1_error)
    }
    __pyx_t_35 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_Rhi.data + __pyx_t_54 * __pyx_v_Rhi.strides[0]) )));
    __pyx_t_3 = __pyx_PyComplex_FromComplex(__pyx_t_35); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_39 = NULL;
    if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_4))) {
    ...
    __pyx_t_2 = (__pyx_t_39) ? __Pyx_PyObject_Call2Args(__pyx_t_4, __pyx_t_39, __pyx_t_3) : __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_3);
    __Pyx_XDECREF(__pyx_t_39); __pyx_t_39 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyNumber_Multiply(__pyx_t_36, __pyx_t_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = NULL;
    ...
    __pyx_t_37 = (__pyx_t_2) ? __Pyx_PyObject_Call2Args(__pyx_t_1, __pyx_t_2, __pyx_t_4) : __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_4);
    __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    if (unlikely(!__pyx_t_37)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_37);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_14 = __pyx_PyFloat_AsDouble(__pyx_t_37); if (unlikely((__pyx_t_14 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_37); __pyx_t_37 = 0;
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_55 < 0) {
      __pyx_t_55 += __pyx_v_matrix.shape[0];
      if (unlikely(__pyx_t_55 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_55 >= __pyx_v_matrix.shape[0])) __pyx_t_12 = 0;
    if (__pyx_t_56 < 0) {
      __pyx_t_56 += __pyx_v_matrix.shape[1];
      if (unlikely(__pyx_t_56 < 0)) __pyx_t_12 = 1;
    } else if (unlikely(__pyx_t_56 >= __pyx_v_matrix.shape[1])) __pyx_t_12 = 1;
    if (__pyx_t_57 < 0) {
      __pyx_t_57 += __pyx_v_matrix.shape[2];
      if (unlikely(__pyx_t_57 < 0)) __pyx_t_12 = 2;
    } else if (unlikely(__pyx_t_57 >= __pyx_v_matrix.shape[2])) __pyx_t_12 = 2;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 71, __pyx_L1_error)
    }
    *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_55 * __pyx_v_matrix.strides[0]) ) + __pyx_t_56 * __pyx_v_matrix.strides[1]) ) + __pyx_t_57 * __pyx_v_matrix.strides[2]) )) = __pyx_t_14;
  }

  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":73
 *         matrix[i, 4, 4] = np.real(Rvi[i] * np.conjugate(Rhi[i]))
 * 
 *     return matrix             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("fresnelpy.bin.bin_fresnel.reflection.bin_reflection_matrix_extended", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fresnelpy.bin.bin_fresnel.reflection.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fresnelpy.bin.bin_fresnel.reflection.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fresnelpy.bin.bin_fresnel.reflection.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fresnelpy.bin.bin_fresnel.reflection._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_reflection(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_reflection},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "reflection",
    __pyx_k_Created_on_18_04_19_by_ibaris, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("bin_reflection", (void (*)(void))__pyx_f_9fresnelpy_3bin_11bin_fresnel_10reflection_bin_reflection, "PyObject *(__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("bin_reflection_matrix", (void (*)(void))__pyx_f_9fresnelpy_3bin_11bin_fresnel_10reflection_bin_reflection_matrix, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("bin_reflection_matrix_extended", (void (*)(void))__pyx_f_9fresnelpy_3bin_11bin_fresnel_10reflection_bin_reflection_matrix_extended, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initreflection(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initreflection(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_reflection(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_reflection(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_reflection(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'reflection' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_reflection(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("reflection", __pyx_methods, __pyx_k_Created_on_18_04_19_by_ibaris, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fresnelpy__bin__bin_fresnel__reflection) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fresnelpy.bin.bin_fresnel.reflection")) {
      if (unlikely(PyDict_SetItemString(modules, "fresnelpy.bin.bin_fresnel.reflection", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":7
 * """
 ...
 */
  ...
  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":10
 * cimport numpy as np
 * from libc.math cimport sin, cos
 * import cmath             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fresnelpy/bin/bin_fresnel/reflection.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * # cython: cdivision=True
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fresnelpy.bin.bin_fresnel.reflection", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fresnelpy.bin.bin_fresnel.reflection");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
