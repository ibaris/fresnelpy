...
static int __Pyx_modinit_function_import_code(void) {
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "bin_reflection", (void (**)(void))&__pyx_f_9fresnelpy_3bin_11bin_fresnel_10reflection_bin_reflection, "PyObject *(__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
