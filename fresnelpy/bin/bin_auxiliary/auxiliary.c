...
#define __PYX_HAVE__fresnelpy__bin__bin_auxiliary__auxiliary
#define __PYX_HAVE_API__fresnelpy__bin__bin_auxiliary__auxiliary
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "fresnelpy/bin/bin_auxiliary/auxiliary.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
/* Module declarations from 'fresnelpy.bin.bin_auxiliary.auxiliary' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static double __pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON;
...
#define __Pyx_MODULE_NAME "fresnelpy.bin.bin_auxiliary.auxiliary"
extern int __pyx_module_is_main_fresnelpy__bin__bin_auxiliary__auxiliary;
int __pyx_module_is_main_fresnelpy__bin__bin_auxiliary__auxiliary = 0;

/* Implementation of 'fresnelpy.bin.bin_auxiliary.auxiliary' */
...
static const char __pyx_k_Created_on_17_04_19_by_ibaris[] = "\nCreated on 17.04.19 by ibaris\n";
...
static const char __pyx_k_For_materials_with_gain_it_s_amb[] = "For materials with gain, it's ambiguous which beam is incoming vs outgoing. Please see: https://arxiv.org/abs/1603.02720 Appendix C. \nn: {0}, xza: {1}";
...
static const char __pyx_k_The_dimensions_of_the_entered_pa[] = "The dimensions of the entered parameters must be the same: n = {0}, xza = {1}";
...
static PyObject *__pyx_kp_s_The_dimensions_of_the_entered_pa;
...
/* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":15
...
static PyObject *__pyx_f_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_bin_is_forward_angle_real(__Pyx_memviewslice __pyx_v_n, __Pyx_memviewslice __pyx_v_xza) {
  ...
  __Pyx_RefNannySetupContext("bin_is_forward_angle_real", 0);

  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":26
 *     """
 *     cdef:
 ...
 *         char * error_string
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_xza); 
  __pyx_v_xmax = __pyx_t_1;

  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":27
 *     cdef:
 *         Py_ssize_t i, xmax = len(xza)
 *         double complex[:] ny = np.empty_like(n)             # <<<<<<<<<<<<<<
 *         char * error_string
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_empty_like); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_n, 1, (PyObject *(*)(char *)) __pyx_memview_get___pyx_t_double_complex, (int (*)(char *, PyObject *)) __pyx_memview_set___pyx_t_double_complex, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
  ...
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_ny = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":29
 *         double complex[:] ny = np.empty_like(n)
 *         char * error_string
 *         np.ndarray answer = np.zeros_like(xza, dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_xza, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_int); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 29, __pyx_L1_error)
  ...
  __pyx_v_answer = ((PyArrayObject *)__pyx_t_7);
  __pyx_t_7 = 0;

  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":31
 *         np.ndarray answer = np.zeros_like(xza, dtype=np.int)
 * 
 *     if n.shape[0] != xza.shape[0]:             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_8 = (((__pyx_v_n.shape[0]) != (__pyx_v_xza.shape[0])) != 0);
  if (unlikely(__pyx_t_8)) {

    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":33
 *     if n.shape[0] != xza.shape[0]:
 *         raise AssertionError("The dimensions of the entered parameters must "
 *                              "be the same: n = {0}, xza = {1}".format(str(n.shape[0]), str(xza.shape[0])))             # <<<<<<<<<<<<<<
 * 
 *     for i in range(xmax):
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_The_dimensions_of_the_entered_pa, __pyx_n_s_format); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyInt_FromSsize_t((__pyx_v_n.shape[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyInt_FromSsize_t((__pyx_v_xza.shape[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = NULL;
    __pyx_t_9 = 0;
    ...
    if (PyFunction_Check(__pyx_t_2)) {
      ...
      __pyx_t_7 = __Pyx_PyFunction_FastCall(__pyx_t_2, __pyx_temp+1-__pyx_t_9, 2+__pyx_t_9); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 33, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_2)) {
      PyObject *__pyx_temp[3] = {__pyx_t_3, __pyx_t_4, __pyx_t_5};
      __pyx_t_7 = __Pyx_PyCFunction_FastCall(__pyx_t_2, __pyx_temp+1-__pyx_t_9, 2+__pyx_t_9); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 33, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    #endif
    {
      ...
      __pyx_t_4 = 0;
      __pyx_t_5 = 0;
      __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_10, NULL); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 33, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    }
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":32
 * 
 *     if n.shape[0] != xza.shape[0]:
 *         raise AssertionError("The dimensions of the entered parameters must "             # <<<<<<<<<<<<<<
 *                              "be the same: n = {0}, xza = {1}".format(str(n.shape[0]), str(xza.shape[0])))
 * 
 */
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_builtin_AssertionError, __pyx_t_7); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 32, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 */
  ...
  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":35
 *                              "be the same: n = {0}, xza = {1}".format(str(n.shape[0]), str(xza.shape[0])))
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
    ...
    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":36
 * 
 *     for i in range(xmax):
 *         if n[i].real * n[i].imag < 0:             # <<<<<<<<<<<<<<
 *             raise AssertionError("For materials with gain, it's ambiguous which beam is incoming vs outgoing. "
 ...
 */
    ...
    __pyx_t_9 = -1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_v_n.shape[0];
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_9 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_n.shape[0])) __pyx_t_9 = 0;
    ...
    __pyx_t_9 = -1;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_v_n.shape[0];
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_9 = 0;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_n.shape[0])) __pyx_t_9 = 0;
    if (unlikely(__pyx_t_9 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_9);
      __PYX_ERR(0, 36, __pyx_L1_error)
    }
    __pyx_t_8 = (((__Pyx_CREAL((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_14 * __pyx_v_n.strides[0]) )))) * __Pyx_CIMAG((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_15 * __pyx_v_n.strides[0]) ))))) < 0.0) != 0);
    if (unlikely(__pyx_t_8)) {

      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":39
 *             raise AssertionError("For materials with gain, it's ambiguous which beam is incoming vs outgoing. "
 *                                  "Please see: https://arxiv.org/abs/1603.02720 Appendix C. \n"
 ...
 *         ny[i] = n[i] * cos(xza[i])
 */
      __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_For_materials_with_gain_it_s_amb, __pyx_n_s_format); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 39, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_16 = __pyx_v_i;
      __pyx_t_9 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_n.shape[0];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_n.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 39, __pyx_L1_error)
      }
      __pyx_t_17 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_16 * __pyx_v_n.strides[0]) )));
      __pyx_t_10 = __pyx_PyComplex_FromComplex(__pyx_t_17); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 39, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_5 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_10); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 39, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_18 = __pyx_v_i;
      __pyx_t_9 = -1;
      if (__pyx_t_18 < 0) {
        __pyx_t_18 += __pyx_v_xza.shape[0];
        if (unlikely(__pyx_t_18 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_18 >= __pyx_v_xza.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 39, __pyx_L1_error)
      }
      __pyx_t_10 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_18 * __pyx_v_xza.strides[0]) )))); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 39, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_4 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_10); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 39, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = NULL;
      __pyx_t_9 = 0;
      ...
      if (PyFunction_Check(__pyx_t_7)) {
        ...
        __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_7, __pyx_temp+1-__pyx_t_9, 2+__pyx_t_9); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 39, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_7)) {
        PyObject *__pyx_temp[3] = {__pyx_t_10, __pyx_t_5, __pyx_t_4};
        __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_7, __pyx_temp+1-__pyx_t_9, 2+__pyx_t_9); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 39, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_10); __pyx_t_10 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":37
 *     for i in range(xmax):
 *         if n[i].real * n[i].imag < 0:
 *             raise AssertionError("For materials with gain, it's ambiguous which beam is incoming vs outgoing. "             # <<<<<<<<<<<<<<
 *                                  "Please see: https://arxiv.org/abs/1603.02720 Appendix C. \n"
 *                                  "n: {0}, xza: {1}".format(str(n[i]), str(xza[i])))
 */
      __pyx_t_7 = __Pyx_PyObject_CallOneArg(__pyx_builtin_AssertionError, __pyx_t_2); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
    ...
    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":41
 *                                  "n: {0}, xza: {1}".format(str(n[i]), str(xza[i])))
 * 
 *         ny[i] = n[i] * cos(xza[i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_9 = -1;
    if (__pyx_t_19 < 0) {
      __pyx_t_19 += __pyx_v_n.shape[0];
      if (unlikely(__pyx_t_19 < 0)) __pyx_t_9 = 0;
    } else if (unlikely(__pyx_t_19 >= __pyx_v_n.shape[0])) __pyx_t_9 = 0;
    if (unlikely(__pyx_t_9 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_9);
    ...
    } else if (unlikely(__pyx_t_20 >= __pyx_v_xza.shape[0])) __pyx_t_9 = 0;
    if (unlikely(__pyx_t_9 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_9);
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    ...
    __pyx_t_9 = -1;
    if (__pyx_t_21 < 0) {
      __pyx_t_21 += __pyx_v_ny.shape[0];
      if (unlikely(__pyx_t_21 < 0)) __pyx_t_9 = 0;
    } else if (unlikely(__pyx_t_21 >= __pyx_v_ny.shape[0])) __pyx_t_9 = 0;
    if (unlikely(__pyx_t_9 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_9);
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    *((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_21 * __pyx_v_ny.strides[0]) )) = __Pyx_c_prod_double((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_19 * __pyx_v_n.strides[0]) ))), __pyx_t_double_complex_from_parts(cos((*((double *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_20 * __pyx_v_xza.strides[0]) )))), 0));

    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":44
 * 
 * 
 ...
 */
    ...
    __pyx_t_9 = -1;
    if (__pyx_t_22 < 0) {
      __pyx_t_22 += __pyx_v_ny.shape[0];
      if (unlikely(__pyx_t_22 < 0)) __pyx_t_9 = 0;
    } else if (unlikely(__pyx_t_22 >= __pyx_v_ny.shape[0])) __pyx_t_9 = 0;
    if (unlikely(__pyx_t_9 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_9);
      __PYX_ERR(0, 44, __pyx_L1_error)
    }
    __pyx_t_8 = ((fabs(__Pyx_CIMAG((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_22 * __pyx_v_ny.strides[0]) ))))) > __pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON) != 0);
    if (__pyx_t_8) {

      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":47
 *             # Either evanescent decay or lossy medium. Either way, the one that
 *             # decays is the forward-moving wave
 *             if (ny[i].imag > 0):             # <<<<<<<<<<<<<<
 *                 answer[i] = 1
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_v_ny.shape[0];
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_23 >= __pyx_v_ny.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 47, __pyx_L1_error)
      }
      __pyx_t_8 = ((__Pyx_CIMAG((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_23 * __pyx_v_ny.strides[0]) )))) > 0.0) != 0);
      if (__pyx_t_8) {

        /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":48
 *             # decays is the forward-moving wave
 *             if (ny[i].imag > 0):
 *                 answer[i] = 1             # <<<<<<<<<<<<<<
 *             else:
 *                 answer[i] = 0
 */
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_1, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 48, __pyx_L1_error)
 ...
 */
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":50
 *                 answer[i] = 1
 *             else:
 *                 answer[i] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      /*else*/ {
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_0, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 50, __pyx_L1_error)
      }
      __pyx_L8:;
 ...
 */
    ...
    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":53
 * 
 *         else:
 *             if (ny[i].real > 0):             # <<<<<<<<<<<<<<
 *                 answer[i] = 1
 ...
 */
    /*else*/ {
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_v_ny.shape[0];
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_24 >= __pyx_v_ny.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 53, __pyx_L1_error)
      }
      __pyx_t_8 = ((__Pyx_CREAL((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_24 * __pyx_v_ny.strides[0]) )))) > 0.0) != 0);
      if (__pyx_t_8) {

        /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":54
 *         else:
 *             if (ny[i].real > 0):
 *                 answer[i] = 1             # <<<<<<<<<<<<<<
 *             else:
 *                 answer[i] = 0
 */
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_1, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 54, __pyx_L1_error)
 ...
 */
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":56
 *                 answer[i] = 1
 *             else:
 *                 answer[i] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      /*else*/ {
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_0, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 56, __pyx_L1_error)
      }
      __pyx_L9:;
    }
    __pyx_L7:;

    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":58
 *                 answer[i] = 0
 * 
 *         if answer[i] == 1:             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_7 = __Pyx_GetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    ...
    if (__pyx_t_8) {
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":59
 * 
 *         if answer[i] == 1:
 *             if (ny[i].imag < -EPSILON or ny[i].real < -EPSILON             # <<<<<<<<<<<<<<
 *                 or n[i].real * cos(xza[i]) < -EPSILON):
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_v_ny.shape[0];
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_ny.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 59, __pyx_L1_error)
      }
      __pyx_t_26 = ((__Pyx_CIMAG((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_25 * __pyx_v_ny.strides[0]) )))) < (-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)) != 0);
      if (!__pyx_t_26) {
      } else {
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":60
 *         if answer[i] == 1:
 *             if (ny[i].imag < -EPSILON or ny[i].real < -EPSILON
 *                 or n[i].real * cos(xza[i]) < -EPSILON):             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_v_ny.shape[0];
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_27 >= __pyx_v_ny.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 59, __pyx_L1_error)
      }
 ...
 * 
 */
      __pyx_t_26 = ((__Pyx_CREAL((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_27 * __pyx_v_ny.strides[0]) )))) < (-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)) != 0);
      if (!__pyx_t_26) {
      } else {
        __pyx_t_8 = __pyx_t_26;
        goto __pyx_L12_bool_binop_done;
 ...
 */
      ...
      } else if (unlikely(__pyx_t_28 >= __pyx_v_n.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_29 < 0) {
        __pyx_t_29 += __pyx_v_xza.shape[0];
        if (unlikely(__pyx_t_29 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_29 >= __pyx_v_xza.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 60, __pyx_L1_error)
      }
      __pyx_t_26 = (((__Pyx_CREAL((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_28 * __pyx_v_n.strides[0]) )))) * cos((*((double *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_29 * __pyx_v_xza.strides[0]) ))))) < (-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)) != 0);
      __pyx_t_8 = __pyx_t_26;
 ...
 */
      if (__pyx_t_8) {
        ...
        /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":62
 *                 or n[i].real * cos(xza[i]) < -EPSILON):
 * 
 *                 answer[i] = -1             # <<<<<<<<<<<<<<
 * 
 *         else:
 */
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_neg_1, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 62, __pyx_L1_error)
 ...
 */
    ...
    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":65
 * 
 *         else:
 *             if (ny[i].imag > -EPSILON or ny[i].real > -EPSILON             # <<<<<<<<<<<<<<
 *                 or n[i].real * cos(xza[i]) > -EPSILON):
 ...
 */
    /*else*/ {
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_30 < 0) {
        __pyx_t_30 += __pyx_v_ny.shape[0];
        if (unlikely(__pyx_t_30 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_30 >= __pyx_v_ny.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 65, __pyx_L1_error)
      }
      __pyx_t_26 = ((__Pyx_CIMAG((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_30 * __pyx_v_ny.strides[0]) )))) > (-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)) != 0);
      if (!__pyx_t_26) {
      } else {
        __pyx_t_8 = __pyx_t_26;
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":66
 *         else:
 *             if (ny[i].imag > -EPSILON or ny[i].real > -EPSILON
 *                 or n[i].real * cos(xza[i]) > -EPSILON):             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_31 < 0) {
        __pyx_t_31 += __pyx_v_ny.shape[0];
        if (unlikely(__pyx_t_31 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_31 >= __pyx_v_ny.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 65, __pyx_L1_error)
      }
 ...
 * 
 */
      __pyx_t_26 = ((__Pyx_CREAL((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_31 * __pyx_v_ny.strides[0]) )))) > (-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)) != 0);
      if (!__pyx_t_26) {
      } else {
        __pyx_t_8 = __pyx_t_26;
        goto __pyx_L16_bool_binop_done;
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_32 < 0) {
        __pyx_t_32 += __pyx_v_n.shape[0];
        if (unlikely(__pyx_t_32 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_32 >= __pyx_v_n.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_33 < 0) {
        __pyx_t_33 += __pyx_v_xza.shape[0];
        if (unlikely(__pyx_t_33 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_33 >= __pyx_v_xza.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 66, __pyx_L1_error)
      }
      __pyx_t_26 = (((__Pyx_CREAL((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_32 * __pyx_v_n.strides[0]) )))) * cos((*((double *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_33 * __pyx_v_xza.strides[0]) ))))) > (-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)) != 0);
      __pyx_t_8 = __pyx_t_26;
 ...
 */
      if (__pyx_t_8) {
        ...
        /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":68
 *                 or n[i].real * cos(xza[i]) > -EPSILON):
 * 
 *                 answer[i] = -1             # <<<<<<<<<<<<<<
 * 
 *     return answer
 */
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_neg_1, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 68, __pyx_L1_error)
 ...
 */
  ...
  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":70
 *                 answer[i] = -1
 * 
 *     return answer             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("fresnelpy.bin.bin_auxiliary.auxiliary.bin_is_forward_angle_real", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":73
 * 
 * 
...
static PyObject *__pyx_f_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_bin_is_forward_angle_cpx(__Pyx_memviewslice __pyx_v_n, __Pyx_memviewslice __pyx_v_xza) {
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_xmax;
  __Pyx_memviewslice __pyx_v_ny = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyArrayObject *__pyx_v_answer = 0;
  ...
  __Pyx_RefNannySetupContext("bin_is_forward_angle_cpx", 0);

  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":84
 *     """
 *     cdef:
 *         Py_ssize_t i, xmax = len(xza)             # <<<<<<<<<<<<<<
 *         double complex[:] ny = np.empty_like(n)
 ...
 */
  ...
  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":85
 *     cdef:
 *         Py_ssize_t i, xmax = len(xza)
 *         double complex[:] ny = np.empty_like(n)             # <<<<<<<<<<<<<<
 *         char * error_string
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_empty_like); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_n, 1, (PyObject *(*)(char *)) __pyx_memview_get___pyx_t_double_complex, (int (*)(char *, PyObject *)) __pyx_memview_set___pyx_t_double_complex, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_4))) {
    __pyx_t_5 = PyMethod_GET_SELF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds___pyx_t_double_complex(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_ny = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":87
 *         double complex[:] ny = np.empty_like(n)
 *         char * error_string
 *         np.ndarray answer = np.zeros_like(xza, dtype=np.int)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_xza, 1, (PyObject *(*)(char *)) __pyx_memview_get___pyx_t_double_complex, (int (*)(char *, PyObject *)) __pyx_memview_set___pyx_t_double_complex, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_int); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_7) < 0) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":90
 * 
 * 
 *     if n.shape[0] != xza.shape[0]:             # <<<<<<<<<<<<<<
 *         raise AssertionError("The dimensions of the entered parameters must "
 ...
 */
  ...
  if (unlikely(__pyx_t_8)) {
    ...
    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":92
 *     if n.shape[0] != xza.shape[0]:
 *         raise AssertionError("The dimensions of the entered parameters must "
 *                              "be the same: n = {0}, xza = {1}".format(str(n.shape[0]), str(xza.shape[0])))             # <<<<<<<<<<<<<<
 * 
 *     for i in range(xmax):
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_The_dimensions_of_the_entered_pa, __pyx_n_s_format); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyInt_FromSsize_t((__pyx_v_n.shape[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyInt_FromSsize_t((__pyx_v_xza.shape[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 92, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = NULL;
    __pyx_t_9 = 0;
    ...
    if (PyFunction_Check(__pyx_t_2)) {
      PyObject *__pyx_temp[3] = {__pyx_t_3, __pyx_t_4, __pyx_t_5};
      __pyx_t_7 = __Pyx_PyFunction_FastCall(__pyx_t_2, __pyx_temp+1-__pyx_t_9, 2+__pyx_t_9); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 92, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_2)) {
      PyObject *__pyx_temp[3] = {__pyx_t_3, __pyx_t_4, __pyx_t_5};
      __pyx_t_7 = __Pyx_PyCFunction_FastCall(__pyx_t_2, __pyx_temp+1-__pyx_t_9, 2+__pyx_t_9); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 92, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    #endif
    {
      ...
      __pyx_t_4 = 0;
      __pyx_t_5 = 0;
      __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_10, NULL); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 92, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    }
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":91
 * 
 *     if n.shape[0] != xza.shape[0]:
 *         raise AssertionError("The dimensions of the entered parameters must "             # <<<<<<<<<<<<<<
 *                              "be the same: n = {0}, xza = {1}".format(str(n.shape[0]), str(xza.shape[0])))
 * 
 */
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_builtin_AssertionError, __pyx_t_7); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 91, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":94
 *                              "be the same: n = {0}, xza = {1}".format(str(n.shape[0]), str(xza.shape[0])))
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 *         if n[i].real * n[i].imag < 0:
 ...
 */
  ...
  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
    ...
    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":95
 * 
 *     for i in range(xmax):
 *         if n[i].real * n[i].imag < 0:             # <<<<<<<<<<<<<<
 *             raise AssertionError("For materials with gain, it's ambiguous which beam is incoming vs outgoing. "
 ...
 */
    ...
    if (unlikely(__pyx_t_8)) {
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":98
 *             raise AssertionError("For materials with gain, it's ambiguous which beam is incoming vs outgoing. "
 *                                  "Please see: https://arxiv.org/abs/1603.02720 Appendix C. \n"
 *                                  "n: {0}, xza: {1}".format(str(n[i]), str(xza[i])))             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_For_materials_with_gain_it_s_amb, __pyx_n_s_format); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 98, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_16 = __pyx_v_i;
      __pyx_t_9 = -1;
      if (__pyx_t_16 < 0) {
      ...
      __pyx_t_17 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_16 * __pyx_v_n.strides[0]) )));
      __pyx_t_10 = __pyx_PyComplex_FromComplex(__pyx_t_17); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 98, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_5 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_10); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 98, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_18 = __pyx_v_i;
      __pyx_t_9 = -1;
      ...
      __pyx_t_17 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_18 * __pyx_v_xza.strides[0]) )));
      __pyx_t_10 = __pyx_PyComplex_FromComplex(__pyx_t_17); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 98, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_4 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_10); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 98, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = NULL;
      __pyx_t_9 = 0;
      ...
      if (PyFunction_Check(__pyx_t_7)) {
        PyObject *__pyx_temp[3] = {__pyx_t_10, __pyx_t_5, __pyx_t_4};
        __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_7, __pyx_temp+1-__pyx_t_9, 2+__pyx_t_9); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 98, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_10); __pyx_t_10 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_7)) {
        PyObject *__pyx_temp[3] = {__pyx_t_10, __pyx_t_5, __pyx_t_4};
        __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_7, __pyx_temp+1-__pyx_t_9, 2+__pyx_t_9); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 98, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_10); __pyx_t_10 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      ...
      #endif
      {
        __pyx_t_3 = PyTuple_New(2+__pyx_t_9); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 98, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        if (__pyx_t_10) {
          __Pyx_GIVEREF(__pyx_t_10); PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_t_10); __pyx_t_10 = NULL;
        }
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":96
 *     for i in range(xmax):
 *         if n[i].real * n[i].imag < 0:
 *             raise AssertionError("For materials with gain, it's ambiguous which beam is incoming vs outgoing. "             # <<<<<<<<<<<<<<
 *                                  "Please see: https://arxiv.org/abs/1603.02720 Appendix C. \n"
 *                                  "n: {0}, xza: {1}".format(str(n[i]), str(xza[i])))
 */
      __pyx_t_7 = __Pyx_PyObject_CallOneArg(__pyx_builtin_AssertionError, __pyx_t_2); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 96, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_Raise(__pyx_t_7, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 */
    ...
    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":100
 *                                  "n: {0}, xza: {1}".format(str(n[i]), str(xza[i])))
 * 
 *         ny[i] = n[i] * cmath.cos(xza[i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_17 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_19 * __pyx_v_n.strides[0]) )));
    __pyx_t_7 = __pyx_PyComplex_FromComplex(__pyx_t_17); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_cmath); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_cos); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_20 = __pyx_v_i;
    __pyx_t_9 = -1;
    ...
    __pyx_t_17 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_20 * __pyx_v_xza.strides[0]) )));
    __pyx_t_3 = __pyx_PyComplex_FromComplex(__pyx_t_17); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = NULL;
    if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_4))) {
      __pyx_t_5 = PyMethod_GET_SELF(__pyx_t_4);
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyNumber_Multiply(__pyx_t_7, __pyx_t_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_17 = __Pyx_PyComplex_As___pyx_t_double_complex(__pyx_t_4); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 100, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_21 = __pyx_v_i;
    __pyx_t_9 = -1;
    if (__pyx_t_21 < 0) {
    ...
    *((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_21 * __pyx_v_ny.strides[0]) )) = __pyx_t_17;

    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":103
 * 
 * 
 *         if abs(ny[i].imag) > EPSILON:             # <<<<<<<<<<<<<<
 *             # Either evanescent decay or lossy medium. Either way, the one that
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":106
 *             # Either evanescent decay or lossy medium. Either way, the one that
 *             # decays is the forward-moving wave
 *             if (ny[i].imag > 0):             # <<<<<<<<<<<<<<
 *                 answer[i] = 1
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":107
 *             # decays is the forward-moving wave
 *             if (ny[i].imag > 0):
 *                 answer[i] = 1             # <<<<<<<<<<<<<<
 *             else:
 *                 answer[i] = 0
 */
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_1, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 107, __pyx_L1_error)
 ...
 */
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":109
 *                 answer[i] = 1
 *             else:
 *                 answer[i] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      /*else*/ {
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_0, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 109, __pyx_L1_error)
      }
      __pyx_L8:;
 ...
 */
    ...
    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":112
 * 
 *         else:
 *             if (ny[i].real > 0):             # <<<<<<<<<<<<<<
 *                 answer[i] = 1
 ...
 */
    /*else*/ {
      ...
      if (__pyx_t_8) {
        ...
        /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":113
 *         else:
 *             if (ny[i].real > 0):
 *                 answer[i] = 1             # <<<<<<<<<<<<<<
 *             else:
 *                 answer[i] = 0
 */
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_1, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 113, __pyx_L1_error)
 ...
 */
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":115
 *                 answer[i] = 1
 *             else:
 *                 answer[i] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      /*else*/ {
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_0, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 115, __pyx_L1_error)
      }
      __pyx_L9:;
    }
    __pyx_L7:;

    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":117
 *                 answer[i] = 0
 * 
 *         if answer[i] == 1:             # <<<<<<<<<<<<<<
 *             if (ny[i].imag < -EPSILON or ny[i].real < -EPSILON
 ...
 */
    __pyx_t_4 = __Pyx_GetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 117, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    ...
    if (__pyx_t_8) {
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":118
 * 
 *         if answer[i] == 1:
 *             if (ny[i].imag < -EPSILON or ny[i].real < -EPSILON             # <<<<<<<<<<<<<<
 *                 or np.real(n[i] * cmath.cos(xza[i])) < -EPSILON):
 ...
 */
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":119
 *         if answer[i] == 1:
 *             if (ny[i].imag < -EPSILON or ny[i].real < -EPSILON
 *                 or np.real(n[i] * cmath.cos(xza[i])) < -EPSILON):             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_real); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 119, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_28 = __pyx_v_i;
      __pyx_t_9 = -1;
      ...
      __pyx_t_17 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_28 * __pyx_v_n.strides[0]) )));
      __pyx_t_4 = __pyx_PyComplex_FromComplex(__pyx_t_17); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 119, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_cmath); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 119, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_cos); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 119, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_29 = __pyx_v_i;
      __pyx_t_9 = -1;
      ...
      __pyx_t_17 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_29 * __pyx_v_xza.strides[0]) )));
      __pyx_t_5 = __pyx_PyComplex_FromComplex(__pyx_t_17); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 119, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_30 = NULL;
      ...
      __pyx_t_3 = (__pyx_t_30) ? __Pyx_PyObject_Call2Args(__pyx_t_10, __pyx_t_30, __pyx_t_5) : __Pyx_PyObject_CallOneArg(__pyx_t_10, __pyx_t_5);
      ...
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_7 = PyFloat_FromDouble((-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 119, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_10 = PyObject_RichCompare(__pyx_t_2, __pyx_t_7, Py_LT); __Pyx_XGOTREF(__pyx_t_10); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 119, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_26 = __Pyx_PyObject_IsTrue(__pyx_t_10); if (unlikely(__pyx_t_26 < 0)) __PYX_ERR(0, 119, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_8 = __pyx_t_26;
      __pyx_L12_bool_binop_done:;
 ...
 */
      if (__pyx_t_8) {
        ...
        /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":121
 *                 or np.real(n[i] * cmath.cos(xza[i])) < -EPSILON):
 * 
 *                 answer[i] = -1             # <<<<<<<<<<<<<<
 * 
 *         else:
 */
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_neg_1, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 121, __pyx_L1_error)
 ...
 */
    ...
    /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":124
 * 
 *         else:
 *             if (ny[i].imag > -EPSILON or ny[i].real > -EPSILON             # <<<<<<<<<<<<<<
 *                 or np.real(n[i] * cmath.cos(xza[i])) > -EPSILON):
 ...
 */
    /*else*/ {
      ...
      __pyx_t_26 = ((__Pyx_CIMAG((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_31 * __pyx_v_ny.strides[0]) )))) > (-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)) != 0);
      if (!__pyx_t_26) {
      } else {
        __pyx_t_8 = __pyx_t_26;
        goto __pyx_L16_bool_binop_done;
      ...
      /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":125
 *         else:
 *             if (ny[i].imag > -EPSILON or ny[i].real > -EPSILON
 *                 or np.real(n[i] * cmath.cos(xza[i])) > -EPSILON):             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_32 < 0) {
        __pyx_t_32 += __pyx_v_ny.shape[0];
        if (unlikely(__pyx_t_32 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_32 >= __pyx_v_ny.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 124, __pyx_L1_error)
      }
 ...
 * 
 */
      __pyx_t_26 = ((__Pyx_CREAL((*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_ny.data + __pyx_t_32 * __pyx_v_ny.strides[0]) )))) > (-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)) != 0);
      if (!__pyx_t_26) {
      } else {
        __pyx_t_8 = __pyx_t_26;
        goto __pyx_L16_bool_binop_done;
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_real); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_33 = __pyx_v_i;
      __pyx_t_9 = -1;
      if (__pyx_t_33 < 0) {
        __pyx_t_33 += __pyx_v_n.shape[0];
        if (unlikely(__pyx_t_33 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_33 >= __pyx_v_n.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 125, __pyx_L1_error)
      }
      __pyx_t_17 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_n.data + __pyx_t_33 * __pyx_v_n.strides[0]) )));
      __pyx_t_7 = __pyx_PyComplex_FromComplex(__pyx_t_17); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_cmath); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_cos); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_34 = __pyx_v_i;
      __pyx_t_9 = -1;
      if (__pyx_t_34 < 0) {
        __pyx_t_34 += __pyx_v_xza.shape[0];
        if (unlikely(__pyx_t_34 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_34 >= __pyx_v_xza.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 125, __pyx_L1_error)
      }
      __pyx_t_17 = (*((__pyx_t_double_complex *) ( /* dim=0 */ (__pyx_v_xza.data + __pyx_t_34 * __pyx_v_xza.strides[0]) )));
      __pyx_t_4 = __pyx_PyComplex_FromComplex(__pyx_t_17); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_30 = NULL;
      ...
      __pyx_t_3 = (__pyx_t_30) ? __Pyx_PyObject_Call2Args(__pyx_t_5, __pyx_t_30, __pyx_t_4) : __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_4);
      __Pyx_XDECREF(__pyx_t_30); __pyx_t_30 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyNumber_Multiply(__pyx_t_7, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = NULL;
      ...
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = PyFloat_FromDouble((-__pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_5 = PyObject_RichCompare(__pyx_t_10, __pyx_t_2, Py_GT); __Pyx_XGOTREF(__pyx_t_5); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_26 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_26 < 0)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_8 = __pyx_t_26;
      __pyx_L16_bool_binop_done:;
 ...
 */
      if (__pyx_t_8) {
        ...
        /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":127
 *                 or np.real(n[i] * cmath.cos(xza[i])) > -EPSILON):
 * 
 *                 answer[i] = -1             # <<<<<<<<<<<<<<
 * 
 *     return answer
 */
        if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_answer), __pyx_v_i, __pyx_int_neg_1, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 127, __pyx_L1_error)
 ...
 */
  ...
  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":129
 *                 answer[i] = -1
 * 
 *     return answer             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("fresnelpy.bin.bin_auxiliary.auxiliary.bin_is_forward_angle_cpx", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_ny, 1);
  __Pyx_XDECREF((PyObject *)__pyx_v_answer);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fresnelpy.bin.bin_auxiliary.auxiliary.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fresnelpy.bin.bin_auxiliary.auxiliary.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fresnelpy.bin.bin_auxiliary.auxiliary.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fresnelpy.bin.bin_auxiliary.auxiliary._memoryviewslice", /*tp_name*/
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "auxiliary",
    __pyx_k_Created_on_17_04_19_by_ibaris, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_The_dimensions_of_the_entered_pa, __pyx_k_The_dimensions_of_the_entered_pa, sizeof(__pyx_k_The_dimensions_of_the_entered_pa), 0, 0, 1, 0},
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("bin_is_forward_angle_real", (void (*)(void))__pyx_f_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_bin_is_forward_angle_real, "PyObject *(__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("bin_is_forward_angle_cpx", (void (*)(void))__pyx_f_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_bin_is_forward_angle_cpx, "PyObject *(__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("auxiliary", __pyx_methods, __pyx_k_Created_on_17_04_19_by_ibaris, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fresnelpy__bin__bin_auxiliary__auxiliary) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fresnelpy.bin.bin_auxiliary.auxiliary")) {
      if (unlikely(PyDict_SetItemString(modules, "fresnelpy.bin.bin_auxiliary.auxiliary", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":7
 * """
 ...
 */
  ...
  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":10
 * cimport numpy as np
 * from libc.math cimport cos
 * import cmath             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":13
 * 
 * cdef:
 *     double EPSILON = 2.220446049250313e-16 * 100             # <<<<<<<<<<<<<<
 * 
 * cdef bin_is_forward_angle_real(double complex[:] n, double[:] xza):
 */
  __pyx_v_9fresnelpy_3bin_13bin_auxiliary_9auxiliary_EPSILON = (2.220446049250313e-16 * 100.0);

  /* "fresnelpy/bin/bin_auxiliary/auxiliary.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * # cython: cdivision=True
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fresnelpy.bin.bin_auxiliary.auxiliary", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fresnelpy.bin.bin_auxiliary.auxiliary");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
